...
<script type="text/javascript" src="/Public/pc/style/urlredirect.js"></script>
<LINK href="/Public/pc/style/style.css" rel=stylesheet>
<LINK href="/Public/pc/style/jbox.css" rel=stylesheet>
<script language="JavaScript" type="text/javascript" src="/Public/pc/style/jquery.js"></script>
<script language="JavaScript" type="text/javascript" src="/Public/pc/style/functions.js"></script>
<script language="JavaScript" type="text/javascript" src="/Public/pc/style/validForm/FormValid.js"></script>
<script language="JavaScript" type="text/javascript" src="/Public/pc/style/jbox/jquery.jBox-2.3.min.js"></script>
<script language="JavaScript" type="text/javascript" src="/Public/pc/style/search.js"></script>
<script language="JavaScript" type="text/javascript" src="/Public/pc/style/menu.js"></script>
<script language="JavaScript" type="text/javascript" src="/Public/pc/style/jQselect.js"></script>
<script language="JavaScript" type="text/javascript" src="/Public/pc/style/slides.min.jquery.js"></script>
<script language="JavaScript" type="text/javascript" src="/Public/pc/style/jquery.touchSlider.js"></script>
...
<div class="head">
  <div class="headtop">
      <div class="fra1">
          <a href="index.php" title="这里是您的网站名称"><img src="/Public/pc/images/logo.png" alt="这里是您的网站名称" /></a>
            <div class="head-right">
            <span><font>租车<br />热线 </font><label>+86-0000-96877</label></span>
            <div class="search">
               <form id="search" name="search" method="get" action="/index.php/Home/Search/">
...
<div class="fy" style=" background:url(http://0001543.ks.panguweb.cn/upfile/ads/20150804113438-369103644.jpg) center top no-repeat;">
      ...
      <div class="l_pro_t"><?php echo ($topname); ?></div>
        <ul class="l_procon">
          ...
          <?php foreach($son2 as $k=>$v): $cateid=$v['id']; if($contro){ $url="/index.php/Home/carlist/index/cateid/$cateid"; }else{ $url="/index.php/Home/Ry/index/cateid/$cateid"; } ?>
          ...
          <li class="proOne"><a title="<?php echo $v['name'];?>" href="<?php echo $url;?>"><?php echo $v['name'];?></a>
            ...
            <li><a style="padding-left:50px;" title="<?php echo $v1['name'];?>" href="/index.php/Home/Ry/index/cateid/<?php echo $v1['id'];?>"><?php echo $v1['name'];?></a></li>
              <?php endforeach;?>
          <?php endif;?>
            </ul>
...
邮箱：<?php echo (C("EMAIL")); ?> </div>
        ...
        <div class="fyRight">
      			<div class="title"> <span class="fl"><?php echo ($selftop); ?></span> <span class="fr">当前位置：<a href="/index.php" title="首页">首页</a> > 
      			<?php if(is_array($pres)): $i = 0; $__LIST__ = $pres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($i != count($pres)): ?><a href="/index.php/Home/<?php if($vo['type'] == 1): ?>Arlist<?php elseif($vo['type'] == 2): ?>Page<?php elseif($vo['type'] == 3): ?>Message<?php elseif($vo['type'] == 4): ?>Zplist<?php elseif($vo['type'] == 5): ?>Carlist<?php elseif($vo['type'] == 6): ?>Ry<?php elseif($vo['type'] == 7): ?>Job<?php endif; ?>/index/cateid/<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></a> &gt;
      			<?php else: ?>
      			<font><?php echo ($vo["name"]); ?></font><?php endif; endforeach; endif; else: echo "" ;endif; ?>
      			</span></div>
		    <ul class="case-ul">
       		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
		        <a href="/index.php/Home/Article/index/arid/<?php echo ($vo["id"]); ?>" title="<?php echo ($vo["title"]); ?>">
		                <img src="<?php echo ($vo["pic"]); ?>" width="245" height="184" alt="<?php echo ($vo["title"]); ?>" />
      ...
      <div class="foot-mleft">
          <div class="site">网站地图（<a target="_blank" href="sitemap.xml">xml</a> / <a target="_blank" href="sitemap.html">html</a>）</div>        
            ...
            <a title="网站首页" href="/index.php">网站首页</a> 
             ...
             <a title="<?php echo ($vo["name"]); ?>" href="/index.php/Home/<?php if($vo['type'] == 1): ?>Arlist<?php elseif($vo['type'] == 2): ?>Page<?php elseif($vo['type'] == 3): ?>Message<?php elseif($vo['type'] == 4): ?>Zplist<?php elseif($vo['type'] == 5): ?>Carlist<?php elseif($vo['type'] == 6): ?>Ry<?php elseif($vo['type'] == 7): ?>Job<?php endif; ?>/index/cateid/<?php echo ($vo["id"]); ?>" class=""><?php echo ($vo["name"]); ?></a>
