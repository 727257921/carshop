...
<!--     <script src="/Public/dialog/dialog/layer.js"></script>
    ...
    <div class="topbar-inner clearfix">
        ...
        <div class="top-info-wrap">
            <ul class="top-info-list clearfix">
                <li><a href="/index.php/Admin/Admin/edit/id/<?php echo session('id');?>">欢迎您：<?php echo session('rolename'); echo session('username');?></a></li>
...
<div class="container clearfix">
        ...
        <ul class="sidebar-list">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="/index.php/Admin/Privilege/list"><i class="icon-font">&#xe037;</i>权限列表</a></li>
                    <li><a href="/index.php/Admin/Role/list"><i class="icon-font">&#xe046;</i>角色列表</a></li>
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Admin/Index/index');?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">作品管理</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                <form action="/index.php/Admin/Cate/list" method="post">
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        ...
                        <a id="batchDel" href="javascript:void(0)"><i class="icon-font"></i><input form="myform" formaction="/index.php/Admin/Cate/bdel" type="submit" class="btn btn-primary btn2" value="批量删除" /></a>
                        <a id="updateOrd" href="javascript:void(0)"><i class="icon-font"></i><input form="myform" formaction="/index.php/Admin/Cate/sortcate" type="submit" class="btn btn-primary btn2" value="更新排序" /></a>
                    </div>
                </div>
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($cates)): $i = 0; $__LIST__ = $cates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            <td class="tc"><input name="ids[]" value="<?php echo ($vo["id"]); ?>" type="checkbox" class="check"></td>
                            <td>
                            ...
                            <td>
                                ...
                                <a class="link-del" href="/index.php/Admin/Cate/delete/id/<?php echo ($vo["id"]); ?>" onclick="return confirm('确定删除本栏目及其子栏目？');">删除</a>
                            </td>
